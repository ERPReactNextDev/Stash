...
import Form from "../../../components/Asset/AssignedAsset/Form";
import Table from "../../../components/Asset/AssignedAsset/Table";
import Filters from "../../../components/Asset/AssignedAsset/Filters";
...
export default function AssignedAssetPage() {
  ...
  const fetchPosts = async (refId: string) => {
    ...
    try {
      const res = await fetch(
        `/api/Backend/Asset/AssignedAsset/fetch?id=${encodeURIComponent(refId)}`
      );
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `/api/Backend/Asset/AssignedAsset/delete?id=${encodeURIComponent(deleteId)}`,
        { method: "DELETE" }
      );
    ...
    <SessionChecker>
      <ParentLayout>
        <div className="container mx-auto p-4 text-gray-900">
          <h1 className="text-2xl font-bold mb-6">Assigned Asset</h1>
