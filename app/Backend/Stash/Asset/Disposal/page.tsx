...
import Form from "../../../components/Asset/Inventory/Form";
import Table from "../../../components/Asset/Disposal/Table";
import Filters from "../../../components/Asset/Disposal/Filters";
...
export default function AssignedAssetPage() {
    ...
    const fetchPosts = async (refId: string) => {
        ...
        try {
            const res = await fetch(
                `/api/Backend/Asset/Inventory/fetch?id=${encodeURIComponent(refId)}`
            );
    ...
    useEffect(() => {
        // 🔹 Filter for disposal only
        let filtered = posts.filter(post => post.status === "disposal");
        ...
        <SessionChecker>
            <ParentLayout>
                <div className="container mx-auto p-4 text-gray-900">
                    <h1 className="text-2xl font-bold mb-6">Disposal</h1>
