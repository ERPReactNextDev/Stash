...
import Table from "../../../components/Asset/Inventory/Table";
import Filters from "../../../components/Asset/Inventory/Filters";
...
export default function AssignedAssetPage() {
  ...
  useEffect(() => {
    ...
    // 🔹 Exclude assets with status "disposal"
    filtered = filtered.filter(post => post.status !== "disposal");
